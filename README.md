...
- Python v3 : https://www.python.org/downloads/macos/
- Intellij Idea
- Playwright
- Pytest
...
* [Playwright](https://playwright.dev/python/docs/api-testing) - Playwright can be used to get access to the REST API of your application.
